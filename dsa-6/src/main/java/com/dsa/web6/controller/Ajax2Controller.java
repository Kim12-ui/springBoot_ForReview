...
public class Ajax2Controller {
	...
	public ArrayList<PersonDTO> getList() {
		...
		list.add(new PersonDTO("홍길동", 30, "010-1111-1111"));
		list.add(new PersonDTO("김철수", 40, "010-2222-2222"));
		list.add(new PersonDTO("박영희", 50, "010-3333-3333"));
		return list;
	}
